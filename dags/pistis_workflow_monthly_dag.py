...
@dag(start_date=datetime(2023,1,1), schedule="@monthly", catchup=False, render_template_as_native_obj=True, params={
...
def pistis_workflow_monthly():
    ...
    trigger_pistis_job = TriggerDagRunOperator(
              ...
              trigger_dag_id="pistis_job_monthly",
              conf={
