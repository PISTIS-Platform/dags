...
def pistis_workflow_template():
    ...
    #check_pending_jobs() >> self_triggering_pistis_workflow
    #check_pending_jobs() >> build_periodic_workflow() >> check_periodicity_type() >> [triggering_pistis_workflow_hourly, triggering_pistis_workflow_daily, triggering_pistis_workflow_monthly]
    #check_pending_jobs() >> skip_self_triggering
